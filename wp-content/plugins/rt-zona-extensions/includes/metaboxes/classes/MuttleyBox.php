 ...
 * @package         MuttleyBox
 * @author          Mariusz Rek
 * @copyright       2018 Muttley Framework
 */
	...
	class MuttleyBox {
        ...
        */
		private function enqueue() {
			...
			/* UI */
			wp_enqueue_style( 'muttley_box_ui_css', $this->args[ 'admin_path' ] . '/assets/css/jquery-ui'. esc_attr( $this->minified  ) .'.css', false, '2018-01-01', 'screen' );

			/* Metabox stylesheet */
			wp_enqueue_style( 'muttley_box_css', $this->args[ 'admin_path' ] . '/assets/css/box'. esc_attr( $this->minified  ) .'.css', false, '2018-01-01', 'screen' );

			/* Metabox fonts */
			wp_enqueue_style( 'muttley_box_font', $this->args[ 'admin_path' ] . '/assets/css/font-awesome'. esc_attr( $this->minified  ) .'.css', false, '2018-01-01', 'screen' );

			/* Metabox javascripts */
			wp_enqueue_script( 'muttley_box_js', $this->args[ 'admin_path' ] . '/assets/js/box'. esc_attr( $this->minified  ) .'.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-dialog', 'jquery-ui-widget', 'jquery-ui-sortable', 'jquery-ui-droppable', 'jquery-ui-slider', 'jquery-ui-draggable', 'jquery-ui-datepicker'), false, true );
