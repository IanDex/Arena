				...
				echo '<div class="box-tc box-tc-input">';
					...
					if ( $source == 'all' ) {
						...
						echo '<select size="1" class="image-source-select" >';
							...
							echo "<option ". esc_attr( $media_libary ) . " value='media_libary'>" . esc_html__( 'Media libary', 'MuttleyBox Class', $this->textdomain ) . "</option>";
							echo "<option " . esc_attr( $external_link ) . " value='external_link'>" . esc_html__( 'External link', 'MuttleyBox Class', $this->textdomain ) . "</option>";
					...
					echo '<div class="image-holder ' . esc_html(  $holder_classes ) . '">';
						...
						// If image exists
						if ( $image ) {
							echo '<img src="' . esc_html( $image ) . '" alt="' . esc_html__( 'Preview Image', 'MuttleyBox Class', $this->textdomain ) . '">';
						} 
