	...
	class MuttleyBox_bg_generator extends MuttleyBox {
        ...
        */
			...
			if ( isset( self::$_option['dependency']) && is_array( self::$_option['dependency'] ) ) {
				...
				echo '<div class="box-row-input">';
					...
					echo '<div class="box-tc box-tc-input">';
						...
						echo '<div class="bg-holder-wrap" data-add-label="' . esc_attr_x( 'Add Background', 'MuttleyBox Class', $this->textdomain ) . '" data-edit-label="' . esc_attr_x( 'Edit Background', 'MuttleyBox Class', $this->textdomain ) . '">';
						...
						if ( !isset( self::$_option['std'] ) || self::$_option['std'] == '' ) {
							...
							echo '<button class="_button generate-bg" ><i class="fa icon fa-magic"></i>' . esc_html_x( 'Add Background', 'MuttleyBox Class', $this->textdomain ) . '</button>';
							echo '<button class="_button ui-button-delete delete-bg" style="display:none"><i class="fa icon fa-trash-o"></i>' . esc_html_x( 'Remove', 'MuttleyBox Class', $this->textdomain ) . '</button>';
						} else {
							...
							if ( json_decode( $data ) != null ) {
								...
								if ( isset( $data['image'] ) ) {
									...
									// If image exists
									if ( $image ) {
										$preview .= '<img src="' . esc_url( $image ) . '" alt="' . esc_attr_x( 'Preview Image', 'MuttleyBox Class', $this->textdomain ) . '">';
									}
								} 
								if ( isset( $data['color'] ) ) {
								...
								$messages = '<div class="msg msg-warning">' . esc_html_x( 'Set your background again, because current is not compatible with latest framework version.', 'MuttleyBox Class', $this->textdomain ) . '</div>';
							}
							echo '<div class="image-holder bg-image-holder">';
							$this->e_esc( $preview );
							echo '</div>';
							$this->e_esc( $messages );
							echo '<button class="_button generate-bg" ><i class="fa icon fa-magic"></i>' . esc_html_x( 'Edit Background', 'MuttleyBox Class', $this->textdomain ) . '</button>';
							echo '<button class="_button ui-button-delete delete-bg"><i class="fa icon fa-trash-o"></i>' . esc_html_x( 'Remove', 'MuttleyBox Class', $this->textdomain ) . '</button>';
						}
		...
		private function bg_box() {
			...
			echo '<div id="bg-editor-content" class="muttleybox">';
		...
		public function bg_editor() {
			...
			<div class="box-row clearfix">
				<div class="box-row-input">
					<div class="box-tc box-tc-label">
						<label for="color">' . esc_html_x( 'Background Color', 'MuttleyBox Class', $this->textdomain ) . '</label>
					</div>
			...
			<div class="box-row clearfix">
				<div class="box-row-input">
					<div class="box-tc box-tc-label">
						<label for="bg-image">' . esc_html_x( 'Background Image', 'MuttleyBox Class', $this->textdomain ) . '</label>
					</div>
					...
					<div class="box-tc box-tc-input">
						...
						// If image exists
						if ( $image ) {
							$image_html = '<img src="' . esc_attr( $image ) . '" alt="' . esc_attr_x( 'Preview Image', 'MuttleyBox Class', $this->textdomain  ) . '">';
							$is_image = 'is_image'; 
						} else {
							$image_html = '';
							$is_image = ''; 
			...
			$output .= '<div class="box-row clearfix">';
				$output .= '<div class="box-row-input">
						<div class="box-tc box-tc-label">
							<label for="position">' . esc_html_x( 'Background Position', 'MuttleyBox Class', $this->textdomain ) . '</label>
						</div>
					...
					<div class="box-tc box-tc-input">';
						...
						$output .= '<p class="help-box">' . esc_html_x( 'The background-position property sets the starting position of a background image. The first value is the horizontal position and the second value is the vertical. The top left corner is 0 0.', 'MuttleyBox Class', $this->textdomain ) . '</p>';
			...
			$output .= '<div class="box-row clearfix">';
				$output .= '<div class="box-row-input">
						<div class="box-tc box-tc-label">
							<label for="repeat">' . esc_html_x( 'Background Repeat', 'MuttleyBox Class', $this->textdomain ) . '</label>
						</div>
					...
					<div class="box-tc box-tc-input">';
						...
						$output .= '<p class="help-box">' . esc_html_x( 'The background-repeat property sets if/how a background image will be repeated.', 'MuttleyBox Class', $this->textdomain ) . '</p>';
						unset( $select_options );
					$output .= '</div>';
				$output .= '</div>';
				$output .= '<div class="box-row-line"></div>';
			...
			$output .= '<div class="box-row clearfix">';
				$output .= '<div class="box-row-input">
						<div class="box-tc box-tc-label">
							<label for="attachment">' . esc_html_x( 'Background Attachment', 'MuttleyBox Class', $this->textdomain ) . '</label>
						</div>
					...
					<div class="box-tc box-tc-input">';
						...
						$output .= '<p class="help-box">' . esc_html_x( 'The background-attachment property sets whether a background image is fixed or scrolls with the rest of the page.', 'MuttleyBox Class', $this->textdomain ) . '</p>';
						unset( $select_options );
					$output .= '</div>';
				$output .= '</div>';
				$output .= '<div class="box-row-line"></div>';
			...
			$output .= '<div class="box-row clearfix">';
				$output .= '<div class="box-row-input">
						<div class="box-tc box-tc-label">
							<label for="size">' . esc_html_x( 'Background Attachment', 'MuttleyBox Class', $this->textdomain ) . '</label>
						</div>
					...
					<div class="box-tc box-tc-input">';
						...
						$output .= '<p class="help-box">' . esc_html_x( 'The background-size property specifies the size of the background images.', 'MuttleyBox Class', $this->textdomain ) . '</p>';
						unset( $select_options );
					$output .= '</div>';
				$output .= '</div>';
				$output .= '<div class="box-row-line"></div>';
