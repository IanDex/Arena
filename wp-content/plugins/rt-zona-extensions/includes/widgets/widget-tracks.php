...
class r_tracks_widget extends WP_Widget {
	...
	function __construct() {
		...
		/* Create the widget */
		if ( function_exists( 'zona_tracklist' ) && function_exists( 'zona_track' ) && function_exists( 'zona_tracklist_grid' ) ) {
	...
	function widget( $args, $instance ) {
		...
		// Display tracks
	 	if ( $type == 'tracklist' ) {
			echo zona_tracklist( $atts = array( 'id' => $tracks_id, 'style' => 'simple', 'track_action' => 'sp-play-track', 'list_button' => $list_button, 'list_button_action' => 'sp-play-list' ) );
		} else if ( $type == 'tracklist_grid' ) {
			echo zona_tracklist_grid( $atts = array( 'id' => $tracks_id, 'track_action' => 'sp-play-track', 'list_button' => $list_button, 'list_button_action' => 'sp-play-list', 'in_row' => $in_row) );
		}
