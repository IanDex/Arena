	    ...
	    if ( ! empty( $json ) ){
	        ...
	        if ( isset( $json->errors ) ) {
		        ...
		        foreach ( $json as $tweet ) {
		            ...
		            $tweet_text = preg_replace('/http:\/\/([a-z0-9_\.\-\+\&\!\#\~\/\,]+)/i', '<a class="line-link" href="http://$1" target="_blank">http://$1</a>&nbsp;', $tweet_text);
		            $tweet_text = preg_replace('/https:\/\/([a-z0-9_\.\-\+\&\!\#\~\/\,]+)/i', '<a class="line-link" href="https://$1" target="_blank">https://$1</a>&nbsp;', $tweet_text);
